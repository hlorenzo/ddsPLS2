...
modelddsPLSCpp_Rcpp <- function(U, V, X, Y, lambdas, R, n, p, q, lambda0) {
    .Call('_ddsPLS2_modelddsPLSCpp_Rcpp', PACKAGE = 'ddsPLS2', U, V, X, Y, lambdas, R, n, p, q, lambda0)
}
...
bootstrap_Rcpp <- function(U, V, X, Y, lambdas, lambda_prev, R, n_B, doBoot, n, p, q, N_lambdas, lambda0) {
    .Call('_ddsPLS2_bootstrap_Rcpp', PACKAGE = 'ddsPLS2', U, V, X, Y, lambdas, lambda_prev, R, n_B, doBoot, n, p, q, N_lambdas, lambda0)
}
