...
RcppExport SEXP _ddsPLS2_bootstrap_Rcpp(SEXP USEXP, SEXP VSEXP, SEXP XSEXP, SEXP YSEXP, SEXP lambdasSEXP, SEXP lambda_prevSEXP, SEXP RSEXP, SEXP n_BSEXP, SEXP doBootSEXP, SEXP nSEXP, SEXP pSEXP, SEXP qSEXP, SEXP N_lambdasSEXP, SEXP lambda0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd >::type U(USEXP);
